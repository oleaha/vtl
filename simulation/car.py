...
class Car:
    ...
    def execute_command(self):
        ...
        while not self.is_next_pos_available():
            logging.debug("Distance to intersection: " + str(self.LOC.closest_intersection(self.next_command['next_pos'], True)))
            if self.LOC.closest_intersection(self.next_command['next_pos'], True) <= 2:
